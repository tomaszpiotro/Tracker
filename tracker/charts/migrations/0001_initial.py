    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=128, verbose_name=b'title', blank=True)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            model_name='chart',
            name='series',
            field=models.ManyToManyField(related_name='charts', verbose_name=b'series', to='charts.Series'),
            preserve_default=True,
        ),
    ]
